...
class continuousHrAlgorithm(backendLyapunovAlgorithm):
    def solve(self, A: matrixOperator, E: matrixOperator | None, B: matrixOperator): return self.localBackend.lyapunov.solveContinuous(A.data, self.prepareQ(B))

@registerAlgorithm('lyapunov', 'continuousHrGeneralized')
class continuousHrGeneralizedAlgorithm(backendLyapunovAlgorithm):
    def solve(self, A: matrixOperator, E: matrixOperator | None, B: matrixOperator): return self.localBackend.lyapunov.solveContinuousGeneralized(A.data, E.data, self.prepareQ(B))

@registerAlgorithm('lyapunov', 'discreteHr')
class discreteHrAlgorithm(backendLyapunovAlgorithm):
    def solve(self, A: matrixOperator, E: matrixOperator | None, B: matrixOperator): return self.localBackend.lyapunov.solveDiscrete(A.data, self.prepareQ(B))

@registerAlgorithm('lyapunov', 'discreteHrGeneralized')
class discreteHrGeneralizedAlgorithm(backendLyapunovAlgorithm):
    def solve(self, A: matrixOperator, E: matrixOperator | None, B: matrixOperator): return self.localBackend.lyapunov.solveDiscreteGeneralized(A.data, E.data, self.prepareQ(B))
