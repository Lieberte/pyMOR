...
class solverRegistry:
    _solvers, _defaultBackends = {}, {}

    @classmethod
    def register(cls, solverType: str, name: str, solverClass: Type):
        if solverType not in cls._solvers: cls._solvers[solverType] = {}
    ...
    @classmethod
    def list(cls, solverType: str) -> list: return list(cls._solvers.get(solverType, {}).keys())
