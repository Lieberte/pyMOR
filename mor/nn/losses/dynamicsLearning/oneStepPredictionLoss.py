...
nnRegistry.register('losses.dynamicsLearning', 'oneStepPredictionLoss', oneStepPredictionLoss)
nnRegistry.register('losses.dynamicsLearning', 'multiStepRolloutLoss', multiStepRolloutLoss)
