...
from mor.nn.trainers.representationLearning.autoEncoderTrainerTorch import autoEncoderTrainerTorch
...
nnRegistry.register('trainers.dynamicsLearning', 'dynamicsTrainerTorch', dynamicsTrainerTorch)
